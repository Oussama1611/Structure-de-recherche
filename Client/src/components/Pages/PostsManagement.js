...
function PostById() {
  ...
  return (
    <div>
      <div>
        <h2 style={{ margin: "10px 500px " }}>
          Vous avez {listOfPosts.length} publication(s)
        </h2>
      </div>
      <div>
                ...
                <p>
                  ...
                  <span>
                    <a
                      ...
                      href={`http://localhost:3000/profil/${value.UserId}`}
                    >
                      Moi
                    </a>
                  </span>
      ...
      <div>
        <Link to="/new-post">
          <button className="new-post">Nouvelle Publication</button>
        </Link>
      </div>
    </div>
  );

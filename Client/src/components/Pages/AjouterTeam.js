  ...
  return (
    <AuthContext.Provider value={{ authState, setAuthState }}>
      <div className="login-container">
        ...
        />
        <label>Nom proposé a l'équipe</label>
        <input
          className="login-form__input"
          type="text"
          name="labo"
        ...
        <input
          ...
          type="text"
          name="Name"
          placeholder="Nom complet du résponsable"
          onChange={(event) => {
            setFullName(event.target.value);
          }}
        />
        <label>Sommaire et objectif de l'équipe</label>
        <input
          className="login-form__input"
          type="text"
          name="sommaire"
          placeholder="Sommaire et objectif de l'équipe"
          onChange={(event) => {
